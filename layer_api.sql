...
--
-- Host: localhost    Database: layer_api
-- ------------------------------------------------------
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$12000$aXzeWhv73WHD$a0GDC7VwgpHpvkEX2tMfOSWlvg/a8ZMLODoGO8w1xI8=','2017-06-19 22:03:29',0,'anthonio','','','test@yahoo.fr',0,1,'2017-06-19 22:03:29');
...
INSERT INTO `django_content_type` VALUES (1,'log entry','admin','logentry'),(2,'permission','auth','permission'),(3,'group','auth','group'),(4,'user','auth','user'),(5,'content type','contenttypes','contenttype'),(6,'session','sessions','session'),(7,'migration history','south','migrationhistory'),(8,'client','oauth2','client'),(9,'grant','oauth2','grant'),(10,'access token','oauth2','accesstoken'),(11,'refresh token','oauth2','refreshtoken'),(12,'user infos','layer_api','userinfos');
...
--
-- Table structure for table `layer_api_userinfos`
--

DROP TABLE IF EXISTS `layer_api_userinfos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `layer_api_userinfos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  ...
  CONSTRAINT `user_id_refs_id_37a03c00` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `layer_api_userinfos`
--

LOCK TABLES `layer_api_userinfos` WRITE;
/*!40000 ALTER TABLE `layer_api_userinfos` DISABLE KEYS */;
INSERT INTO `layer_api_userinfos` VALUES (1,1,'fname','lname','test@yahoo.fr','010203040054','2000-12-12');
/*!40000 ALTER TABLE `layer_api_userinfos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `oauth2_accesstoken` VALUES (1,1,'34724a3fda544f4092d7cffd6eeae7420218d6e0',1,'2017-07-19 22:03:44',2);
...
INSERT INTO `oauth2_client` VALUES (1,1,'127.0.0.1:8000/anthonio','','17a36acaee6948e9be89b063905e69ab','',1,'anthonio');
...
INSERT INTO `south_migrationhistory` VALUES (1,'oauth2','0001_initial','2017-06-19 22:02:57'),(2,'oauth2','0002_auto__chg_field_client_user','2017-06-19 22:02:57'),(3,'oauth2','0003_auto__add_field_client_name','2017-06-19 22:02:57'),(4,'oauth2','0004_auto__add_index_accesstoken_token','2017-06-19 22:02:57'),(5,'layer_api','0001_initial','2017-06-19 22:02:57'),(6,'layer_api','0002_auto__del_customuser__add_userinfos','2017-06-19 22:02:57');
...
-- Dump completed on 2017-06-19 20:54:23
